...
dataset_No=8
./run -dataset_No $dataset_No -seed_num $seed_num -MC_round $MC_round -eps_for_verification $eps -eta_for_verification $eta -real_time_pw 1|tee -a ./log/${dataset[$dataset_No]}.log
